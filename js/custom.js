...
jQuery(function ($) { "use strict";
	...
	$('#contact-submit').click(function (e) {
		...
		if (error == false) {
			...
			$.post("enviar_email.php", $("#contact-form").serialize(), function (result) {
				...
				if (result == 'sent') {
					...
					$('#contact-submit').removeAttr('disabled').attr('value', 'Mensagem enviada');
					$('#contact-submit').css("backgroundColor", "#6cb670");
					$('#contact-submit').css("color", "#ffffff");
				}
			});
		}
	});
